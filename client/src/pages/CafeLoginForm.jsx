...
function CafeLoginForm() {
  ...
  return (
    <div className="relative w-full h-screen flex justify-around items-center py-10 overflow-y-hidden">
      <a
        href="https://codacitysolutions.com/"
        target="_blank"
        className="absolute bottom-4 left-3 flex items-center cursor-pointer"
      >
        <img src={CodacityLogo} alt="Codacity Logo" className="h-7 w-10" />
        <h2 className="text-xs font-montserrat-700 text-gray pb-1">
          Powered by Codacity Solutions
        </h2>
      </a>
      <div className="flex w-1/2 h-full flex-col justify-center items-center scale-90">
        <h1 className="text-6xl font-montsarret font-montserrat-700 uppercase font-bold pb-4">
          Welcome
        </h1>
        <form
          onSubmit={handleSubmit}
          className="flex flex-col w-[70%] justify-between items-center gap-7 px-10 pt-10"
        >
          <div className="flex gap-1 items-center w-[85%] border-2 border-[#C6C6C6] rounded-xl pr-4 py-1">
            <img
              src={emailLogo}
              alt="Email Logo"
              className="h-[42px] w-[42px] ml-1"
            />
            <input
          ...
          {error && (
            <p className="text-red text-sm font-montserrat-400 -my-3">
              {error}
            </p>
          )}
          ...
          <button
            disabled={isPending}
            className="text-black text-xl rounded-xl w-full font-montsarret font-semibold px-1 py-3 border-blue border-2 shadow-[0_0_7.6px_0_#0158A133]"
          >
        ...
        <div className="text-sm px-10 py-2 mt-2 flex gap-1 font-montsarret font-montserrat-300 italic">
          ...
          <Link to="/register" className="text-blue font-montserrat-500">
            Sign-up
          </Link>
        </div>
        <div className="text-sm px-10 py-2 font-montsarret font-montserrat-300 italic">
          <Link to="/manager" className="text-blue font-montserrat-500">
            Are you a manager?
          </Link>
        </div>
      </div>
